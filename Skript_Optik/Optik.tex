...
\documentclass[paper=a4,twoside=true,,DIV13,BCOR1cm]{scrartcl}

\usepackage{style}


\usepackage{aufgaben_script}
...
%{\par\vspace*{0.5cm}\begin{tikzpicture}\draw node[text width=1.00\linewidth, rounded corners, thick,double, inner sep=1ex,draw]\bgroup}
\newenvironment{lernziele}
{\par\vspace*{0.5cm}\begin{tikzpicture}\draw node[text width=0.98\linewidth, rounded corners, inner sep=2ex,fill, color=black!20]\bgroup}
				{\egroup;\end{tikzpicture}\par\vspace*{0.5cm}}
...
\input{./abbildungen_woelbspiegel.tex}
...
\input{Aufgaben/bademeister.tex}
...
\begin{table}
	...
	\begin{tabular}{ll}
		...
		Diamant 	    & \num{2,42}
	\end{tabular}
	\caption{Brechungsindex einiger ausgewählter Materialien für die Wellenlänge \SI{589}{nm}(gelb-orange) Natrium-D-Linie.}
...
\kloesung{\SI{48.8}{\degree}, \SI{24.4}{\degree}, \SI{33.3}{\degree}}
...
\begin{loesung}
	...
	Zur Totalreflexion kommt es, wenn der Brechungswinkel gleich \SI{90}{\degree} ist.
		...
		Wasser -- Luft: $\sin\alpha_1=\frac{n_2}{n_1}=\frac{1}{\num{1.33}} \to \alpha_1=\SI{48.8}{\degree}$\\
		Diamant -- Luft: $\sin\alpha_1=\frac{n_2}{n_1}=\frac{1}{\num{2.42}} \to \alpha_1=\SI{24.4}{\degree}$\\
		Diamant -- Wasser: $\sin\alpha_1=\frac{n_2}{n_1}=\frac{1.33}{\num{2.42}} \to \alpha_1=\SI{33.3}{\degree}$\\\\
...
\begin{center}
	...
	\begin{tikzpicture}
		\draw [line width=0.05cm] (0,0) rectangle (5,5);%Koerper
		\draw [LS,<-] (2.5,0)--+(-45:2cm);%Lichtstrahl

		%Beschriftung des Winkels
